 ...
 *       instance that implements the natural ordering. (This is also the behavior of Guava's ImmutableSortedMap.) Other implementations of PSortedMap are encouraged to consider doing the same,
