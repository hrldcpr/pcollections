...
public class UnmodifiableAssertions {
  ...
  public static <V> void assertSetMutatorsThrow(Set<V> set, V sampleValue) {
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> set.addAll(asList(sampleValue, sampleValue)));
    assertThrows(UnsupportedOperationException.class, set::clear);
    assertThrows(UnsupportedOperationException.class, () -> set.remove(sampleValue));
    assertThrows(
        UnsupportedOperationException.class, () -> set.removeAll(asList(sampleValue, sampleValue)));
    assertThrows(UnsupportedOperationException.class, () -> set.removeIf(__ -> true));
    assertThrows(
        UnsupportedOperationException.class, () -> set.retainAll(asList(sampleValue, sampleValue)));
  }

  public static <K, V> void assertMapMutatorsThrow(Map<K, V> map, K sampleKey, V sampleValue) {
    assertThrows(UnsupportedOperationException.class, map::clear);
    assertThrows(
        UnsupportedOperationException.class, () -> map.compute(sampleKey, (k, v) -> fail()));
    assertThrows(
        UnsupportedOperationException.class, () -> map.computeIfAbsent(sampleKey, (k) -> fail()));
    assertThrows(
        UnsupportedOperationException.class,
        () -> map.computeIfPresent(sampleKey, (k, v) -> fail()));
    assertThrows(
        UnsupportedOperationException.class,
        () -> map.merge(sampleKey, sampleValue, (k, v) -> fail()));
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> map.putIfAbsent(sampleKey, sampleValue));
