...
public class SerializationTest extends TestCase {
    ...
    public void testSerializationForConsPStack() {
        final ConsPStack<String> initialConsPStack = ConsPStack.from(Arrays.asList(ELEMENT1, ELEMENT2, ELEMENT3));
    ...
    public void testSerializationForMapPBag() {
        final MapPBag<String> initialMapPBag = HashTreePBag.<String> empty()
                .plus(ELEMENT1)
                .plus(ELEMENT2)
                .plus(ELEMENT1)
                .plus(ELEMENT2)
        ...
        assertFalse(deserializedMapPBag.minus(ELEMENT1).minus(ELEMENT1).minus(ELEMENT1).contains(ELEMENT1));
    ...
    public void testSerializationForOrderedPSet() {
        final OrderedPSet<String> initialOrderedPSet = OrderedPSet.from(Arrays.asList(ELEMENT1, ELEMENT2, ELEMENT3));
    ...
    public void testSerializationForTreePVector() {
        final TreePVector<String> initialTreePVector = TreePVector.from(Arrays.asList(ELEMENT1, ELEMENT2, ELEMENT3));
