...
public class Benchmarks {
    ...
    public enum CollectionType {
        LINKED_LIST, ARRAY_LIST, CONS_P_STACK, TREE_P_VECTOR, HASH_SET, HASH_TREE_P_SET, HASH_MAP, HASH_TREE_P_BAG, INT_TREE_P_MAP;
    ...
    public static class LinearAndRandom {
        @Param
        public BaseListType testAgainst; 
    ...
    public static class GeneralCollections {
        @Param
        public BaseListType testAgainst; 
        @Param({"LINKED_LIST", "ARRAY_LIST", "CONS_P_STACK", "TREE_P_VECTOR", "HASH_SET", "HASH_TREE_P_SET", "HASH_MAP", "HASH_TREE_P_BAG", "INT_TREE_P_MAP"})
    ...
    public void init() {
        ...
        collections[LINEAR.ordinal()][CONS_P_STACK.ordinal()]       = pCollectionPlus(ConsPStack.empty(), list);
        collections[LINEAR.ordinal()][TREE_P_VECTOR.ordinal()]      = pCollectionPlus(TreePVector.empty(), list);
        collections[LINEAR.ordinal()][HASH_SET.ordinal()]           = collectionAdd(new HashSet(), list);
        collections[LINEAR.ordinal()][HASH_TREE_P_SET.ordinal()]    = pCollectionPlus(HashTreePSet.empty(), list);
        collections[LINEAR.ordinal()][HASH_TREE_P_BAG.ordinal()]    = pCollectionPlus(HashTreePBag.empty(), list);
        ...
        collections[RANDOM.ordinal()][CONS_P_STACK.ordinal()]       = pCollectionPlus(ConsPStack.empty(), list);
        collections[RANDOM.ordinal()][TREE_P_VECTOR.ordinal()]      = pCollectionPlus(TreePVector.empty(), list);
        collections[RANDOM.ordinal()][HASH_SET.ordinal()]           = collectionAdd(new HashSet(), list);
        collections[RANDOM.ordinal()][HASH_TREE_P_SET.ordinal()]    = pCollectionPlus(HashTreePSet.empty(), list);
        collections[RANDOM.ordinal()][HASH_TREE_P_BAG.ordinal()]    = pCollectionPlus(HashTreePBag.empty(), list);
    ...
    public static class CollectionsWithContains {
        @Param
        public BaseListType testAgainst; 
        @Param({"LINKED_LIST", "ARRAY_LIST", "CONS_P_STACK", "TREE_P_VECTOR", "HASH_SET", "HASH_TREE_P_SET", "HASH_TREE_P_BAG"})
        public CollectionType testWith; 
    }
    ...
    public void get(CollectionsWithGet lrl) {
        listGet(
            (List) collections[lrl.testAgainst.ordinal()][lrl.testWith.ordinal()]);
    }
    ...
    public static class CollectionsWithIterator {
        @Param
        public BaseListType testAgainst; 
        @Param({"LINKED_LIST", "ARRAY_LIST", "CONS_P_STACK", "TREE_P_VECTOR", "HASH_SET", "HASH_TREE_P_SET", "HASH_TREE_P_BAG", "INT_TREE_P_MAP"})
        public CollectionType testWith; 
    }
